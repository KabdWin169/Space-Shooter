...
class Label():
    def __init__(self, text, x, y, size = 25):
        self.font = pygame.font.Font('Sevillana-Regular.ttf', size)
...
class HUD():
    def __init__(self):
        self.score = Label('Score: 0', 60, 20)
        self.lose = Label('Game Over', WIDTH / 2, HEIGHT / 2, 50)
